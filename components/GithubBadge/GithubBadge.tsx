...
const GithubBadgeLink = styled(Link)`
    position: fixed; 
    top: 0; 
    border: 0; 
    right: 0;
...
export default function GithubBadge() {
    return (
        <GithubBadgeLink href="https://github.com/theericzhang/doordash-clone" target="_blank">
            <OctoSVG viewBox="0 0 250 250" aria-hidden="true">
